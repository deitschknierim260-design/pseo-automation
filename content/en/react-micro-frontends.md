...
description: >-
  This article provides a comprehensive guide to react-micro-frontends, covering
  Module Federation, Single SPA, 微前端通信.
date: '2026-05-30'
slug: en/react-micro-frontends
tags:
  - technology
  - programming
  - development
...
react-micro-frontends is a fundamental technology in modern software development. Mastering these skills enables you to build efficient, scalable, and maintainable applications. This comprehensive guide covers essential concepts with practical examples.
...
Module Federation is a key concept that forms the foundation of this technology. It involves understanding how to efficiently manage and manipulate data structures, handle asynchronous operations, and optimize performance.

### Single SPA

Single SPA builds upon the basic concepts and introduces more advanced techniques for handling complex scenarios. This includes advanced state management, performance optimization strategies, and integration patterns.

### 微前端通信

微前端通信 focuses on real-world application and best practices. This section covers production-ready implementation patterns, error handling strategies, and scalability considerations.
